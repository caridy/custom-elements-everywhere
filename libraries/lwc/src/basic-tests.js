...
describe("basic support", function() {
  describe("no children", function() {
    it("can display a Custom Element with no children", function() {
      ...
      let wc = root.shadowRoot.querySelector("ce-without-children");
      expect(wc).to.exist;
    });
  });
  ...
  describe("with children", function() {
    ...
    it("can display a Custom Element with children in a Shadow Root", function() {
      ...
      scratch.appendChild(root);
      let wc = root.shadowRoot.querySelector("ce-with-children");
    ...
    it("can display a Custom Element with children in the Shadow DOM and handle hiding and showing the element", async function() {
      ...
      scratch.appendChild(root);
      await Promise.resolve(); // Give Polymer's dom-if a chance to stamp
      let wc = root.shadowRoot.querySelector("ce-with-children");
      expectHasChildren(wc);
      root.toggle();
      await Promise.resolve();
      ...
      root.toggle();
      await Promise.resolve();
      wc = root.shadowRoot.querySelector("ce-with-children");
      expectHasChildren(wc);
    });
  });
  ...
  describe("attributes and properties", function() {
    ...
    beforeEach(function() {
      ...
      scratch.appendChild(root);
      wc = root.shadowRoot.querySelector("ce-with-properties");
    });
  ...
  describe("events", function() {
    it("can imperatively listen to a DOM event dispatched by a Custom Element", async function() {
      ...
      scratch.appendChild(root);
      let wc = root.shadowRoot.querySelector("ce-with-event");
